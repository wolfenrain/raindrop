...
extension ISUDRaindropExecutor on RaindropExecutor<Delegate> {
  ...
  SelectingBuilder<S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13,
      S14, S15, S16, S17, S18, S19> select<
          S0 extends Selectable<Object?>?,
    ...
    return delegate.select(
        this,
        _Selecting<S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13,
                S14, S15, S16, S17, S18, S19>(s0, s1, s2, s3, s4, s5, s6, s7,
...
typedef SelectFunction = SelectingBuilder<S0, S1, S2, S3, S4, S5, S6, S7, S8,
...
extension DistinctSelect on SelectFunction {
  ...
  /// `distinct()` instead.
  SelectingBuilder<S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13,
      S14, S15, S16, S17, S18, S19> distinct<
          S0 extends Selectable<Object?>?,
          S1 extends Selectable<Object?>?,
          S2 extends Selectable<Object?>?,
          S3 extends Selectable<Object?>?,
      ...
      S18? s18,
      S19? s19]) {
    final builder = this<S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12,
            S13, S14, S15, S16, S17, S18, S19>(s0, s1, s2, s3, s4, s5, s6, s7,
        s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19);
...
extension SelectableColumns on SelectBuilder<
    (
      _Unused,
      _Unused,
      _Unused,
...
extension SelectableColumns0<V0> on SelectBuilder<
    (
      Selectable<V0>,
      _Unused,
      _Unused,
...
extension SelectableColumns1<V0, V1> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      _Unused,
...
extension SelectableColumns2<V0, V1, V2> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2)> from<R>(Schema<R> from) {
    ...
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2)>(
            [selecting.s0!, selecting.s1!, selecting.s2!]),
        #from: from.$,
      }),
    );
  }
...
extension SelectableColumns3<V0, V1, V2, V3> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3)> from<R>(
      Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3)>(
            [selecting.s0!, selecting.s1!, selecting.s2!, selecting.s3!]),
        #from: from.$,
      }),
    );
  }
...
extension SelectableColumns4<V0, V1, V2, V3, V4> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4)> from<R>(
      Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns5<V0, V1, V2, V3, V4, V5> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4, V5)> from<R>(
      Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4, V5)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns6<V0, V1, V2, V3, V4, V5, V6> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4, V5, V6)> from<R>(
      Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4, V5, V6)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns7<V0, V1, V2, V3, V4, V5, V6, V7> on SelectBuilder<
    (
      Selectable<V0>,
      Selectable<V1>,
      Selectable<V2>,
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4, V5, V6, V7)> from<R>(
      Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4, V5, V6, V7)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns8<V0, V1, V2, V3, V4, V5, V6, V7, V8>
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4, V5, V6, V7, V8)>
      from<R>(Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4, V5, V6, V7, V8)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns9<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R, (V0, V1, V2, V3, V4, V5, V6, V7, V8, V9)>
      from<R>(Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting: SelectableResult<(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns10<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10>
  ...
  /// Create a from builder.
  ProjectionFromBuilder<Schema<R>, R,
      (V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10)> from<R>(Schema<R> from) {
    final selecting = config.selecting! as _Selecting;
    return ProjectionFromBuilder(
      executor,
      config: config.copyWith({
        #selecting:
            SelectableResult<(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10)>([
          selecting.s0!,
          selecting.s1!,
          selecting.s2!,
          selecting.s3!,
...
extension SelectableColumns14<V0,
...
extension SelectableColumns15<V0, V1,
...
extension SelectableColumns16<V0, V1, V2,
...
extension SelectableColumns17<V0, V1, V2, V3, V4,
...
extension SelectableColumns18<V0, V1, V2, V3, V4, V5,
...
extension SelectableColumns19<V0, V1, V2, V3, V4, V5, V6,
