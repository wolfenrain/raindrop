...
extension SelectWithLeftJoin0<S extends Schema<R>, R>
...
extension SelectWithLeftJoin1<S extends Schema<R>, R, R0, R1>
...
extension SelectWithLeftJoin2<S extends Schema<R>, R, R0, R1, R2>
...
extension SelectWithLeftJoin3<S extends Schema<R>, R, R0, R1, R2, R3>
...
extension SelectWithLeftJoin4<S extends Schema<R>, R, R0, R1, R2, R3, R4>
...
extension SelectWithLeftJoin5<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5>
...
extension SelectWithLeftJoin6<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin7<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin10<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
        R6, R7, R8, R9, R10>
...
extension SelectWithLeftJoin11<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
        R6, R7, R8, R9, R10, R11>
    on SelectFromBuilder<S, R,
        (R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11)> {
  /// Add a left join clause of the builder.
  SelectFromBuilder<S, R,
      (R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, OR?)> leftJoin<OR>(
    Schema<OR> table, {
    required Filter on,
  }) {
    final result = config.selecting! as SelectableResult;
...
extension SelectWithLeftJoin12<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
        R6, R7, R8, R9, R10, R11, R12>
    on SelectFromBuilder<S, R,
        (R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12)> {
  /// Add a left join clause of the builder.
  SelectFromBuilder<S, R,
          (R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, OR?)>
      leftJoin<OR>(
    Schema<OR> table, {
    required Filter on,
  }) {
...
extension SelectWithLeftJoin13<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin14<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin15<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin16<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin17<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin18<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
...
extension SelectWithLeftJoin19<S extends Schema<R>, R, R0, R1, R2, R3, R4, R5,
