...
void main() {
  ...
  setUp(() async {
    ...
    await db.execute(
      '''
CREATE TABLE players (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, rank TEXT)''',
    );
...
final _PlayerSchema players = sqliteTable('players', _PlayerSchema.new);
